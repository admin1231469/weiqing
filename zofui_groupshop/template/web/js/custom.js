		...
		$scope.modules = [
			{
				...
				data:[
                   {id:'B01',imgurl:'../addons/zofui_groupshop/public/images/slide01.jpg',hrefurl:'',sysurl:'url'},
                   {id:'B02',imgurl:'../addons/zofui_groupshop/public/images/slide02.jpg',hrefurl:'',sysurl:'url'},
                   {id:'B03',imgurl:'../addons/zofui_groupshop/public/images/slide03.jpg',hrefurl:'',sysurl:'url'},
                   {id:'B04',imgurl:'../addons/zofui_groupshop/public/images/slide04.jpg',hrefurl:'',sysurl:'url'}
				]				
			},
            {
				id: "cube",name: "图片魔方",
            ...
            {
				id:'notice',name:'公告模块',
				params:{imgurl:'../addons/zofui_groupshop/public/images/notice.jpg',color:'#000000',bgcolor:'#ffffff',horncolor:'',shownum:1,padding:0,bottomcolor:'#f3f4f9',timer:3},
				data:[]
			},
            {
				id:'title',name:'标题模块',
			...
			},
            {
				...
				params:{
					...
					price:'1',
					hpstyle:'1',
					goodhref: window.sysinfo.siteroot + 'app/index.php?i='+window.sysinfo.uniacid+'&c=entry&do=good&m=zofui_groupshop'
	   ...
	   function clone(myObj){
		...
		$scope.tosearch = function(type,addOrMinus){
            ...
            $.ajax({
                type: 'post',
                dataType:'json',
                url: window.sysinfo.siteroot + '/web/index.php?c=site&a=entry&op=customsearch&do=ajax&m=zofui_groupshop',
                ...
                success: function(data){
					...
					angular.forEach(data.list,function(d,i){
						if(type == 'good'){
							$scope.searchResult.push({id:d.id,title:d.title,url:d.url,img:d.thumpic,realprice:d.realprice,oldprice:d.oldprice,groupnum:d.groupnum});
						}
						if(type == 'card'){
						...
						if(type == 'sort'){
							$scope.searchResult.push({id:d.id,name:d.name,url:d.url});
						}					
					})
					$scope.$apply();
                },
                    ...
                    angular.forEach($scope.searchResult, function(s,index2) {
                        if(s.id==Sid){
							...
							if($scope.showtype == 'good'){
								m.data.push({id:Gid,gid:s.id,img:s.img,title:s.title,price:s.realprice,oldprice:s.oldprice,groupnum:s.groupnum});
...
/*************<!-- 魔方处理end -->*************/		
        ...
        $scope.save = function(n){
           ...
           var pagetype = $("select[name=pagetype]").val();
            ...
            $.ajax({
                type: 'POST',
                url: window.sysinfo.siteroot + '/web/index.php?c=site&a=entry&op=savecustom&do=ajax&m=zofui_groupshop',
                ...
                success: function(data){
                    if(data == 1){
						...
						if(pageid){
							...
							location.href = window.sysinfo.siteroot + '/web/index.php?c=site&a=entry&op=list&do=custom&m=zofui_groupshop';
						}
