...
div;
	...
	}elseif( $_GPC['op'] == 'cancela' ){

		$order = pdo_get('zofui_groupshop_order',array('id'=>$_GPC['oid'],'uniacid'=>$_W['uniacid'],'status'=>3));
		if( empty($order) ) die('未找到订单');

		model_order::cancelDoNotPayOrder($order,$this);
